...
class ContactUsController extends Controller
{
    ...
    public function ContactEdite($id){
     ...
     $update->save();
    	...
    	return redirect()->route('ContactIndex')->with('successMsg','Slider Successfully Update');
    ...
    public function ContactDelete($id){
     ...
     return redirect()->route('ContactIndex')->with('successMsg','Slider Successfully Delete');
