    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            <li class="text-center">
                <img src="{{ asset('backend/img/find_user.png')}}" class="user-image img-responsive"/>
            </li>
            ...
            <li>
             ...
             <li>
                <a class="{{ Request::is('admin/Logo*') ? 'active-menu': '' }}" href="#"><i class="fa fa-building fa-3x"></i> Web Logo <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
             ...
             <li>
                <a class="{{ Request::is('admin/Contact_one*') ? 'active-menu': '' }}" href="#"><i class="fa fa-plug fa-3x"></i> Contact Us <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
            ...
            {{-- <li>
             ...
             {{-- <li>
                <a class="{{ Request::is('admin/Product*') ? 'active-menu': '' }}" href="#"><i class="fa fa-car fa-3x"></i> Products <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                     <li>
                    ...
                    <li>
                        <a href="{{route('ProductIndex')}}">All Product</a>
                    </li>
            ...
            <li>
                <a class="{{ Request::is('admin/AllPatient*') ? 'active-menu': '' }}" href="#"><i class="fa fa-share-square-o fa-3x"></i> All Patient <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{route('AllPatientCreate')}}">Add Patient</a>
                    </li>
                    <li>
                        <a href="{{route('AllPatientIndex')}}">All Patient</a>
                    </li>
            ...
            <li>
                <a class="{{ Request::is('admin/News*') ? 'active-menu': '' }}" href="#"><i class="fa fa-share-square-o fa-3x"></i>News<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    {{-- <li>
                        <a href="{{route('AllPatientCreate')}}">Add Consultnt</a>
                    </li> --}}
...
<!-- 
            ...
            <li>
                <a class="{{ Request::is('admin/SeoSetting*') ? 'active-menu': '' }}" href="#"><i class="fa fa-share-square-o fa-3x"></i> Seo Setting <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
