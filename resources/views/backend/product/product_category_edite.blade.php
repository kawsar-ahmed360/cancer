                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{route('ProductCategoryUpdate',$edite->id)}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{@$edite->category_name}}" name="category_name" placeholder="Category" />
